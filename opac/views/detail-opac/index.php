...
<head>
    ...
    <link rel="shortcut icon" type='image/x-icon' href="<?=Yii::$app->urlManager->createUrl('../uploaded_files/aplikasi/pemprov.png');?>">
    ...
    <div class="box-body" style="padding:20px 0">
      ...
      */    ?>
      ...
      <div class="row">
        <div class="col-md-9">
          <div class="row">
            <div class="col-md-12"><br><img src="<?= $urlcover ?>" width="100%"></div>
            <div class="col-md-12">
            <center style="margin-top:10px; margin-bottom:10px">
              <a class="btn btn-success" href="" data-toggle="modal" data-target=".bs-example-modal-md"  ><i class="glyphicon glyphicon-cog"></i> <?= yii::t('app','Cite This')?></a>&nbsp; &nbsp; &nbsp; &nbsp; 
              <a class="btn btn-success" href="javascript:void(0)" onclick="keranjang(<?= $ids; ?>)" ><i class="glyphicon glyphicon-shopping-cart"></i> <?= yii::t('app','Tampung')?></a>&nbsp; &nbsp; &nbsp; &nbsp; 
              <a class="btn btn-success" href="" ><i class="glyphicon glyphicon-new-window"></i> <?= yii::t('app','Export Record')?></a>
            </center>
